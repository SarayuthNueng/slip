...
#cssmenu ul{
    ...
    <div class="container">
      ...
      <form name="form1" method="post" action="check_edit_pass_admin.php">
            ...
            <table width="972" >
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td colspan="3"><input class="form-control" style="width: 150px;" value="<?=$row_show['pass']?>" name="Pass_Student" id="Pass_Student" size="10" required></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
